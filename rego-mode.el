...
;; Copyright (C) 2020 Sibi Prabakaran, slightly modified!
...
(defvar rego-mode-keywords (regexp-opt '("default" "not" "package" "import" "as" "with" "else" "some" "in" "every" "if" "contains") 'symbols))
...
(define-derived-mode rego-mode prog-mode
  ...
  ;; 20250301-2210
  ;; The following is better handled by a general-purpose reformatting
  ;; framework like apheleia.
  ;; ;; (when (and (fboundp 'rego-format-on-save-mode) rego-format-at-save)
